...
password = 'refaldi'
cxn_str = f'mongodb+srv://test:{password}@cluster0.tjgiegp.mongodb.net/?retryWrites=true&w=majority'
client = MongoClient(cxn_str, tlsCAFile=certifi.where())
db = client.scrapingweek13
...
for _ in range(5):
    ...
    for restaurant in restaurants:
        ...
        link = business_name.text.split('.')[-1].strip()
